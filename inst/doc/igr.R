...
## ----example-igr-poi-plot, message=FALSE, fig.alt="A map of Ireland with a dot at the south west corner of each sample grid reference."----
...
## ----example-igr-pol-plot, fig.alt="A map of Ireland with polygons spanning each sample grid reference. The polygons range in size from 100 km square to 1 m square."----
if (exists("ie_uk_sf")) {
